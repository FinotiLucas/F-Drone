import sys
from src.views import DFormNovoProjeto, DFormUTM, DFormPlanejamentoDeVoo, DFormOrientacaoInterior, DFormSpatialReference, DFormSpaceResection
...
from src.components import imageViewer
import json,os 
...
class FDrone(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowIcon(QtGui.QIcon("assets/icons/logo.svg"))
        ...
        self.ferramenta_importar_imagem = QAction(QtGui.QIcon("assets/icons/geral/svg/image-svgrepo-com.svg"), "Importar Imagem", self)
        ...
        ferramenta_visualizar_estatisticas = QAction(QtGui.QIcon("assets/icons/geral/svg/pie-chart.svg"), "Visualizar Estatísticas", self)
        ...
        ferramenta_georeferrenciar = QAction(QtGui.QIcon("assets/icons/geral/svg/maps-and-flags-map-svgrepo-com.svg"), "Georreferenciar Imagem", self)
        ...
        ferramenta_gerar_ortofoto = QAction(QtGui.QIcon("assets/icons/geral/svg/geography-map-svgrepo-com.svg"), "Gerar Ortofoto", self)
        ...
        ferramenta_gerar_relatorio = QAction(QtGui.QIcon("assets/icons/geral/svg/document-svgrepo-com.svg"), "Gerar Relatório", self)
    ...
    def IniciarFDrone(self):
        ...
        self.mb_novo_projeto = QAction(QtGui.QIcon("assets/icons/geral/svg/folder.svg"), "Novo Projeto", self)
        ...
        self.mb_orientacao_interior = QAction(QtGui.QIcon("assets/icons/drone2-icons/svg/photo-camera.svg"), "Parâmetros de Orientação Interior", self)
        ...
        self.mb_planejamento_voo = QAction(QtGui.QIcon("assets/icons/drone-icons/svg/023-street-map.svg"), "Planejamento de Voo", self)
        ...
        self.mb_spaceresection = QAction(QtGui.QIcon("assets/icons/drone-icons/svg/031-radar.svg"), "Recessão Espacial", self)
        ...
        self.mb_spatial_reference = QAction(QtGui.QIcon("assets/icons/drone2-icons/svg/placeholder.svg"), "Referencia Espacial", self)
        ...
        self.botao_sair = QAction(QtGui.QIcon("assets/icons/geral/svg/door.svg"), "Sair", self)
        ...
        # Submenu menu sobre
        self.botao_sobre = QAction(QtGui.QIcon("assets/icons/geral/svg/Help_and_Support_23389"), "Sobre F-Drone", self)
